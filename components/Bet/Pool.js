...
const Pool = () => {
  ...
  return (
    <div className={styles.container}>
      <div style={{minHeight: '100vh', width: '100vw', display: 'flex', flexDirection: 'row'}}>
        <div style={{ width: '16%', backgroundColor:"#6300bf", display: "flex", flexDirection: 'column', }}>
            <div style={{paddingLeft: "16px", color: '#c280ff', font: '700 normal 18px sans', marginTop: '18px'}} > Betting Pool </div> 
            <div style={{backgroundColor: '#c280ff', color: 'white', height: '48px', paddingTop: '16px', font: '400 normal 14px sans', marginTop: '18px', paddingLeft: '18px'}} >  🌐  Official Pool </div> 
        </div>
        <div style={{ width: '84%', backgroundColor:"white", paddingRight:"16px", paddingLeft:"16px"}}>
